...
export default function TreasurerDashboardPage({
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6 animate-fadeIn py-4">
        ...
        <div className="flex items-center justify-between">
          <Link
            href={`/${roomSlug}`}
            className="inline-flex items-center gap-1.5 text-xs font-medium text-[#9C8599] hover:text-[#5C435A] transition-colors"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#E27396] bg-[#FFF5F8] hover:bg-[#FCE4EC] border border-[#EFCFE3] rounded-xl transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#9C8599] hover:text-[#FF8DA1] bg-white hover:bg-[#FFF1F2] border border-[#FCE4EC] rounded-xl shadow-xs transition-colors"
            >
        ...
        <div className="text-center space-y-2 py-4">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-3xl bg-gradient-to-tr from-[#EB9AB2] to-[#D9849D] text-white shadow-pastel mb-1">
            <ShieldCheck className="w-7 h-7" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#5C435A] flex flex-col sm:flex-row items-center justify-center gap-2">
            <span>ระบบเหรัญญิก ({displayName})</span>
            {isSuperAdmin && (
              <span className="px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-extrabold bg-[#FFF1F2] text-[#FF8DA1] border border-[#FFC4D0] flex items-center gap-1 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
          ...
          <div
            ...
            className="pastel-card p-6 sm:p-8 bg-white border-2 border-[#BDECD2] hover:border-[#88D4AB] hover:shadow-pastel cursor-pointer transition-all group flex flex-col justify-between"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-[#ECFDF5] text-[#76BFA0] border border-[#A7F3D0] flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0">
                <CheckSquare className="w-7 h-7" />
              </div>
              <h2 className="text-xl font-bold text-[#5C435A] group-hover:text-[#76BFA0] transition-colors">
                เช็คชื่อจ่ายเงินห้อง
              </h2>
            </div>

            <div className="pt-6 mt-6 border-t border-[#FCE4EC] flex items-center justify-between text-sm font-bold text-[#76BFA0]">
              <span>เข้าสู่หน้าเช็คชื่อ</span>
              <div className="w-8 h-8 rounded-xl bg-[#88D4AB] text-white flex items-center justify-center group-hover:translate-x-1 transition-transform shadow-xs">
          ...
          <div
            ...
            className="pastel-card p-6 sm:p-8 bg-white border-2 border-[#EFCFE3] hover:border-[#EB9AB2] hover:shadow-pastel cursor-pointer transition-all group flex flex-col justify-between"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-[#FFF5F8] text-[#E27396] border border-[#EFCFE3] flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0">
                <Receipt className="w-7 h-7" />
              </div>
              <h2 className="text-xl font-bold text-[#5C435A] group-hover:text-[#E27396] transition-colors">
                รายการอื่นๆ (รายรับ - รายจ่าย)
              </h2>
            </div>

            <div className="pt-6 mt-6 border-t border-[#FCE4EC] flex items-center justify-between text-sm font-bold text-[#E27396]">
              <span>เข้าสู่หน้ารายการอื่นๆ</span>
              <div className="w-8 h-8 rounded-xl bg-[#EB9AB2] text-white flex items-center justify-center group-hover:translate-x-1 transition-transform shadow-xs">
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          </div>
        ...
        <div className="pt-2 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-[#9C8599] hover:text-[#5C435A] bg-white border border-[#FCE4EC] shadow-xs hover:bg-[#FFF5F8] transition-colors"
          >
            <Settings className="w-3.5 h-3.5 text-[#EB9AB2]" />
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1 border-b border-[#FCE4EC]">
        <div className="flex items-center gap-3">
          <button
            onClick={() => setActiveTab("menu")}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[#E27396] bg-white hover:bg-[#FFF5F8] border border-[#EFCFE3] rounded-xl shadow-xs transition-colors"
          >
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <div className="flex items-center gap-1 bg-white p-1 rounded-xl border border-[#FCE4EC] shadow-xs">
            <button
              onClick={() => setActiveTab("checkin")}
          ...
          <button
            onClick={handleLockSession}
            className="p-1.5 text-[#9C8599] hover:text-[#FF8DA1] bg-white hover:bg-[#FFF1F2] border border-[#FCE4EC] rounded-xl shadow-xs transition-colors"
            title="ออกจากระบบ"
          >
      ...
      {activeTab === "transactions" && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-base text-[#5C435A]">
              รายการอื่นๆ (รายรับ - รายจ่าย)
            </h3>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold text-white bg-[#EB9AB2] hover:bg-[#D9849D] shadow-pastel transition-all"
            >
      ...
      {activeTab === "settings" && (
        <div className="pastel-card p-6 max-w-md bg-white shadow-pastel mx-auto">
          <h3 className="text-base font-bold text-[#5C435A] mb-4">
          ...
          <form onSubmit={handleSaveSettings} className="space-y-4 text-xs sm:text-sm">
            <div>
              <label className="flex items-center gap-1.5 font-semibold text-[#9C8599] mb-1">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[#FFF5F8] border border-[#FCE4EC] rounded-xl text-[#5C435A] font-semibold focus:outline-none focus:ring-2 focus:ring-[#EB9AB2]"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-[#EB9AB2] hover:bg-[#D9849D] shadow-pastel transition-colors"
            >
              บันทึก
            </button>
          </form>
