...
export default function StudentList({
  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      ...
      {/* VERTICAL Student List (Clean & Minimalist) */}
      <div className="pastel-card overflow-hidden">
        <div className="p-3 bg-[#FAF5FF] border-b border-[#EFE8F6] flex items-center justify-between text-xs font-semibold text-[#7B708A]">
          ...
          <span className="pr-2">สถานะ</span>
        </div>
            ...
            filteredStudents.map((student) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between p-2.5 sm:px-4 cursor-pointer select-none transition-colors ${
                    isPaid
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-xs sm:text-sm font-medium text-[#332941]">
                      {student.name}
                    </div>
                  </div>
